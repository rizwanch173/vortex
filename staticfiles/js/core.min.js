        ...
        l.waypoint(
          function () {
            for (
              ...
              if ((n && (a = parseFloat((i / e) * r).toFixed(o)), s))
          ...
          (this._setPosition =
            ...
            function (t, e, i, s, n) {
              o.options.horizontalScrolling && r.setLeft(t, e, i),
                o.options.verticalScrolling && r.setTop(t, s, n);
            });
      },
          ...
          this.options.parallaxBackgrounds &&
            ...
            t.each(function () {
              ...
              o.data("stellar-backgroundStartingLeft")
                ...
                : (o.data("stellar-backgroundStartingLeft", r[0]),
                  o.data("stellar-backgroundStartingTop", r[1])),
                (t =
          ...
          for (o in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              !u && a && h
                ...
                : ((!u && c) || (u && r.oldScroll >= l.triggerPoint)) &&
  ...
  (function (t) {
      ...
      open: function (t) {
        ...
        if (!f.isOpen) {
          (f.types = []),
            ...
            f.bgOverlay ||
              ((f.bgOverlay = p("bg").on("click" + _, function () {
                f.close();
              })),
              (f.wrap = p("wrap")
                .attr("tabindex", -1)
            ...
            f.st.preloader &&
              (f.preloader = p("preloader", f.container, f.st.tLoading));
          ...
          u("BeforeOpen"),
            ...
            f.fixedContentPos
              ...
              : f.wrap.css({ top: b.scrollTop(), position: "absolute" }),
            (!1 !== f.st.fixedBgPos &&
      ...
      appendContent: function (t, e) {
        (f.content = t)
          ? f.st.showCloseBtn && f.st.closeBtnInside && !0 === f.currTemplate[e]
            ? f.content.find(".mfp-close").length || f.content.append(d())
            : (f.content = t)
          : (f.content = ""),
          u("BeforeAppend"),
          ...
          "string" == typeof t
            ? "open" === t
              ? ((e = a ? n.data("magnificPopup") : n[0].magnificPopup),
                ...
                (s = e.items
                  ? e.items[i]
                  : ((s = n), e.delegate && (s = s.find(e.delegate)), s.eq(i))),
          ...
          if ((C(), t.src)) {
            ...
            return (
              n.length
                ? ((i = n[0].parentNode) &&
                    i.tagName &&
                    (S || ((T = s.hiddenClass), (S = p(T)), (T = "mfp-" + T)),
                    (z = n.after(S).detach().removeClass(T))),
                  f.updateStatus("ready"))
                : (f.updateStatus("error", s.tNotFound), (n = h("<div>"))),
              (t.inlineElement = n)
            );
          }
    ...
    h.magnificPopup.registerModule(P, {
      ...
      proto: {
        ...
        getAjax: function (s) {
          $ && h(document.body).addClass($), f.updateStatus("loading");
          var t = h.extend(
            {
              url: s.src,
          ...
          return (
            ...
            !(!o || !o.enabled) &&
              ...
              c("UpdateStatus" + t, function (t, e) {
                e.text &&
                  (e.text = D(e.text, f.currItem.index, f.items.length));
              }),
  ...
  (function (t) {
    ...
    function e(t) {
      ...
      if (
        ...
        1 === i.deltaMode
          ? ((n *= e = c.data(this, "mousewheel-line-height")),
            (r *= e),
            (o *= e))
          : 2 === i.deltaMode &&
            ((n *= e = c.data(this, "mousewheel-page-height")),
            (r *= e),
            (o *= e));
        var a = Math.max(Math.abs(r), Math.abs(o));
        return (
          (f && !(a < f)) || (u(i, (f = a)) && (f /= 40)),
          u(i, a) && ((n /= 40), (o /= 40), (r /= 40)),
    ...
    if (c.event.fixHooks)
      for (var s = t.length; s; ) c.event.fixHooks[t[--s]] = c.event.mouseHooks;
      ...
      (this.WOW =
        ...
        (o.prototype.start = function () {
          ...
          if (
            ...
            (this.all = function () {
              for (
                var t, e = [], i = 0, s = (t = this.boxes).length;
                i < s;
                i++
              )
                (n = t[i]), e.push(n);
                          ...
                          function () {
                            for (
                              var t,
                                e = [],
                                i = 0,
                                s = (t = o.addedNodes || []).length;
                              i < s;
                              i++
                            )
                              (n = t[i]), e.push(this.doSync(n));
                            return e;
                          }.call(r)
                        );
                    return e;
        ...
        (o.prototype.resetStyle = function () {
          for (var t, e, i = [], s = 0, n = (e = this.boxes).length; s < n; s++)
          ...
          for (o in t)
            (r = t[o]),
              ...
              e.push(
                function () {
                  for (
                    var t, e = [], i = 0, s = (t = this.vendors).length;
                    i < s;
                    i++
                  )
                    (a = t[i]),
                      e.push(
                        (n["" + a + o.charAt(0).toUpperCase() + o.substr(1)] =
                          r)
                      );
                  return e;
                }.call(this)
        ...
        (o.prototype.vendorCSS = function (t, e) {
          for (
            ...
            (n = i[r]), (o = o || s.getPropertyCSSValue("-" + n + "-" + e));
          return o;
        }),
          ...
          return !this.scrolled ||
            ...
            (this.boxes = function () {
              for (
                ...
                (n = t[i]) && (this.isVisible(n) ? this.show(n) : e.push(n));
              return e;
            }.call(this)),
